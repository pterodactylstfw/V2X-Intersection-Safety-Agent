...
nodes = {
    # --- MARGINI ---
    "W_START": (0, 670), "W_END": (0, 630),
    "E_START": (1500, 630), "E_END": (1500, 670),
    "S1_START": (420, 800), "S1_END": (380, 800),
    "S2_START": (1120, 800), "S2_END": (1080, 800),
    "NW_START": (0, 100), "NW_END": (0, 50),
    "NE_ONEWAY_START": (1000, 0),

    # --- INTERSECȚIA 1 (Jos-Stânga) ---
    "I1_W_STOP": (340, 670), "I1_W_EXIT": (340, 630),
    "I1_S_STOP": (420, 710), "I1_S_EXIT": (380, 710),
    "I1_E_STOP": (460, 630), "I1_E_EXIT": (460, 670),
    "I1_N_STOP": (380, 590), "I1_N_EXIT": (420, 590),

    # --- INTERSECȚIA 2 (Jos-Dreapta) ---
    "I2_W_STOP": (1040, 670), "I2_W_EXIT": (1040, 630),
    "I2_S_STOP": (1120, 710), "I2_S_EXIT": (1080, 710),
    "I2_E_STOP": (1160, 630), "I2_E_EXIT": (1160, 670),
    ...
    "I3_NW_STOP": (350, 280), "I3_NW_EXIT": (400, 240), 
    "I3_S_STOP": (420, 360), "I3_S_EXIT": (380, 360),
...
edges = [
    ...
    ("W_START", "I1_W_STOP", 1), ("I1_W_EXIT", "W_END", 1),
    ("I1_E_EXIT", "I2_W_STOP", 1), ("I2_W_EXIT", "I1_E_STOP", 1),
    ("I2_E_EXIT", "E_END", 1), ("E_START", "I2_E_STOP", 1),

    # 2. Verticala Stânga
    ("S1_START", "I1_S_STOP", 1), ("I1_S_EXIT", "S1_END", 1),
    ("I1_N_EXIT", "I3_S_STOP", 1), ("I3_S_EXIT", "I1_N_STOP", 1),

    # 3. Verticala Dreapta
    ("S2_START", "I2_S_STOP", 1), ("I2_S_EXIT", "S2_END", 1),

    # 4. Diagonala Nord-Vest
    ("NW_START", "I3_NW_STOP", 1), ("I3_NW_EXIT", "NW_END", 1),
